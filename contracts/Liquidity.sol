...
contract LiquidityExamples is IERC721Receiver {
    ...
    {
        // for this example, we will provide equal amounts of liquidity on both assets.
        ...
        // already be created and initalized in order to mint
    ...
    function collectAllFees() external returns (uint256 amount0, uint256 amount1) {
        ...
        // alternaitve cna set recipient to msg.sender and avoid another transaction in `sendToOwner`
    ...
    function getLiqudity(uint _tokenId) external view returns (uint128) {
        (
            ,
            ,
            ,
